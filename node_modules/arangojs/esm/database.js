...
import { Collection, CollectionType, collectionToString, isArangoCollection, } from "./collection.js";
...
export class Database {
    ...
    query(query, bindVars, options = {}) {
        ...
        return this.request({
            ...
            retryOnConflict,
            timeout,
        }, (res) => new BatchedArrayCursor(this, res.parsedBody, res.arangojsHostUrl, allowDirtyRead).items);
    }
