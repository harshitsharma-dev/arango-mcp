...
class Collection {
    ...
    async exists() {
        try {
            ...
            if ((0, error_js_1.isArangoError)(err) && err.errorNum === codes_js_1.COLLECTION_NOT_FOUND) {
                return false;
            }
            throw err;
        }
    ...
    create(options = {}) {
        ...
        if (opts.computedValues) {
            opts.computedValues = opts.computedValues.map((computedValue) => {
                if ((0, aql_js_1.isAqlLiteral)(computedValue.expression)) {
                    return {
                        ...computedValue,
                        expression: computedValue.expression.toAQL(),
                    };
                }
                if ((0, aql_js_1.isAqlQuery)(computedValue.expression)) {
                    return {
                        ...computedValue,
    ...
    documentId(selector) {
        return (0, documents_js_1._documentHandle)(selector, this._name);
    }
    async documentExists(selector, options = {}) {
        ...
        try {
            return await this._db.request({
                method: "HEAD",
                path: `/_api/document/${encodeURI((0, documents_js_1._documentHandle)(selector, this._name))}`,
                headers,
            }, (res) => {
    ...
    _edges(selector, options = {}, direction) {
        ...
        return this._db.request({
            ...
            search: {
                direction,
                vertex: (0, documents_js_1._documentHandle)(selector, this._name, false),
            },
        });
    }
    ...
    index(selector) {
        return this._db.request({
            path: `/_api/index/${encodeURI((0, indexes_js_1._indexHandle)(selector, this._name))}`,
        });
    }
    ensureIndex(options) {
        return this._db.request({
