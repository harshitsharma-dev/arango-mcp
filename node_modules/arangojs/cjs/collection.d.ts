...
import { EnsureGeoIndexOptions, EnsureIndexOptions, EnsureInvertedIndexOptions, EnsureMdiIndexOptions, EnsureMdiPrefixedIndexOptions, EnsurePersistentIndexOptions, EnsureTtlIndexOptions, GeoIndex, HiddenIndex, Index, IndexSelector, InvertedIndex, MdiIndex, MdiPrefixedIndex, PersistentIndex, TtlIndex } from "./indexes.js";
/**
...
export interface DocumentCollection<EntryResultType extends Record<string, any> = any, EntryInputType extends Record<string, any> = EntryResultType> extends ArangoCollection {
     ...
     */
    shards(details?: false): Promise<ArangoApiResponse<CollectionMetadata & CollectionProperties & {
        shards: string[];
    }>>;
    /**
     ...
     */
    shards(details: true): Promise<ArangoApiResponse<CollectionMetadata & CollectionProperties & {
     ...
     * ```
     */
    indexes<IndexType extends Index | HiddenIndex = Index>(options?: IndexListOptions): Promise<IndexType[]>;
    /**
     ...
     * ```
     */
    ensureIndex(details: EnsureMdiPrefixedIndexOptions): Promise<ArangoApiResponse<MdiPrefixedIndex & {
        isNewlyCreated: boolean;
    }>>;
    /**
...
export declare class Collection<EntryResultType extends Record<string, any> = any, EntryInputType extends Record<string, any> = EntryResultType> implements EdgeCollection<EntryResultType, EntryInputType>, DocumentCollection<EntryResultType, EntryInputType> {
    ...
    loadIndexes(): Promise<boolean>;
    shards(details?: boolean): Promise<ArangoApiResponse<CollectionMetadata & CollectionProperties & {
        shards: any;
    }>>;
    rename(newName: string): Promise<ArangoApiResponse<CollectionMetadata>>;
    truncate(options?: CollectionTruncateOptions): Promise<ArangoApiResponse<CollectionMetadata>>;
    ...
    indexes(options?: IndexListOptions): Promise<any>;
    index(selector: IndexSelector): Promise<any>;
    ensureIndex(options: EnsurePersistentIndexOptions | EnsureGeoIndexOptions | EnsureTtlIndexOptions | EnsureMdiIndexOptions | EnsureMdiPrefixedIndexOptions | EnsureInvertedIndexOptions): Promise<any>;
