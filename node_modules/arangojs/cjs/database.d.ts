...
export declare class Database {
     ...
     */
    request<ReturnType = any>(options: RequestOptions & {
        absolutePath?: boolean;
    }, transform?: (res: ArangojsResponse) => ReturnType): Promise<ReturnType>;
    /**
     * @internal
     *
     * Performs an arbitrary HTTP request against the database.
     ...
     * ```
     */
    availability(graceful?: boolean): Promise<ServerAvailability>;
    /**
     ...
     * ```
     */
    rebalanceCluster(options: ClusterRebalanceOptions): Promise<ClusterRebalanceResult>;
    /**
     ...
     * ```
     */
    setQueryCacheProperties(properties: QueryCachePropertiesOptions): Promise<QueryCacheProperties>;
    /**
     ...
     * ```
     */
    installService(mount: string, source: File | Blob | string, options?: InstallServiceOptions): Promise<ServiceInfo>;
    /**
     ...
     * ```
     */
    replaceService(mount: string, source: File | Blob | string, options?: ReplaceServiceOptions): Promise<ServiceInfo>;
    /**
     ...
     * ```
     */
    upgradeService(mount: string, source: File | Blob | string, options?: UpgradeServiceOptions): Promise<ServiceInfo>;
    /**
