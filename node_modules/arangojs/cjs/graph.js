...
function coerceEdgeDefinition(options) {
    ...
    edgeDefinition.collection = (0, collection_js_1.collectionToString)(options.collection);
    edgeDefinition.from = Array.isArray(options.from)
        ? options.from.map(collection_js_1.collectionToString)
        : [(0, collection_js_1.collectionToString)(options.from)];
    edgeDefinition.to = Array.isArray(options.to)
        ? options.to.map(collection_js_1.collectionToString)
        : [(0, collection_js_1.collectionToString)(options.to)];
...
class GraphVertexCollection {
    ...
    async vertexExists(selector) {
        try {
            return await this._db.request({
                method: "HEAD",
                path: `/_api/gharial/${encodeURIComponent(this.graph.name)}/vertex/${encodeURI((0, documents_js_1._documentHandle)(selector, this._name))}`,
            }, () => true);
        }
        catch (err) {
            if (err.code === 404) {
    ...
    async vertex(selector, options = {}) {
        ...
        try {
            ...
            if ((0, error_js_1.isArangoError)(err) && err.errorNum === codes_js_1.DOCUMENT_NOT_FOUND) {
                return null;
            }
            throw err;
        }
...
class GraphEdgeCollection {
    ...
    async edgeExists(selector) {
        try {
            return await this._db.request({
                method: "HEAD",
                path: `/_api/gharial/${encodeURIComponent(this.graph.name)}/edge/${encodeURI((0, documents_js_1._documentHandle)(selector, this._name))}`,
            }, () => true);
        }
        catch (err) {
            if (err.code === 404) {
...
class Graph {
    ...
    async exists() {
        try {
            ...
            if ((0, error_js_1.isArangoError)(err) && err.errorNum === codes_js_1.GRAPH_NOT_FOUND) {
                return false;
            }
            throw err;
        }
            ...
            body: {
                orphanCollections: orphanCollections &&
                    (Array.isArray(orphanCollections)
                        ? orphanCollections.map(collection_js_1.collectionToString)
                        : [(0, collection_js_1.collectionToString)(orphanCollections)]),
                edgeDefinitions: edgeDefinitions.map(coerceEdgeDefinition),
                isSmart,
                name: this._name,
                options: { ...opts, satellites: satellites?.map(collection_js_1.collectionToString) },
            },
            search: { waitForSync },
    ...
    vertexCollection(collection) {
        return new GraphVertexCollection(this._db, (0, collection_js_1.collectionToString)(collection), this);
    }
    /**
    ...
    addVertexCollection(collection, options = {}) {
        ...
        return this._db.request({
            ...
            body: {
                collection: (0, collection_js_1.collectionToString)(collection),
                options: { ...opts, satellites: satellites?.map(collection_js_1.collectionToString) },
            },
        }, (res) => res.parsedBody.graph);
    }
    ...
    removeVertexCollection(collection, dropCollection = false) {
        return this._db.request({
            method: "DELETE",
            path: `/_api/gharial/${encodeURIComponent(this._name)}/vertex/${encodeURIComponent((0, collection_js_1.collectionToString)(collection))}`,
            search: {
                dropCollection,
            },
        }, (res) => res.parsedBody.graph);
    ...
    edgeCollection(collection) {
        return new GraphEdgeCollection(this._db, (0, collection_js_1.collectionToString)(collection), this);
    }
    /**
    ...
    replaceEdgeDefinition(collectionOrEdgeDefinitionOptions, edgeDefinitionOrOptions, options = {}) {
        ...
        return this._db.request({
            method: "PUT",
            path: `/_api/gharial/${encodeURIComponent(this._name)}/edge/${encodeURIComponent((0, collection_js_1.collectionToString)(collection))}`,
            body: {
                ...coerceEdgeDefinition(edgeDefinition),
                options: { ...opts, satellites: satellites?.map(collection_js_1.collectionToString) },
            },
